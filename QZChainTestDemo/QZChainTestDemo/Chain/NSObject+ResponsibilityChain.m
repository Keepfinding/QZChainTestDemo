...
static char *responsibilityChainKey = "responsibilityChainKey";

- (void)setResponsibilityChain:(ResponsibilityChain *)responsibilityChain {
    
    responsibilityChain.object = self;
    objc_setAssociatedObject(self, responsibilityChainKey, responsibilityChain, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (ResponsibilityChain *)responsibilityChain {
    
    return objc_getAssociatedObject(self, responsibilityChainKey);
}
